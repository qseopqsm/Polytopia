...
public class INTERFAZ extends JFrame {
    ...
    static Point tamañoPanel = new Point(600,600);
    ...
    public INTERFAZ(Map c, Jugador j) {
        ...
        setSize(tamañoPanel.x,tamañoPanel.y);
        ...
        contenedor.addMouseListener(new MouseJugador(this,j,c));
        setVisible(true);
        contenedor.addMouseMotionListener(new Mouse(this));
